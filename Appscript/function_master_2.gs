...
function onOpen() {
  ...
  ui.createMenu('⚙️ Additional Tools')
      ...
      .addSeparator()
      .addSubMenu(ui.createMenu('Update Paket GS')
        .addItem('GS Khusus - Lampung', 'paketGSpartOne')
        .addItem('GS Banten - Sulsel', 'paketGSpartTwo')
        .addItem('GS Sulbar - Papua', 'paketGSpartThree')
        .addSeparator()
        .addItem('All BP2JK', 'updatePaketGS')
